...
\begin{example}[Complete Statistical Summary]
...
\begin{figure}[h!]
    ...
    \addplot[mseViaBlue!80!black, thick] coordinates {(-3,0) (-3,0.02)};
    \addplot[mseViaBlue!80!black, thick] coordinates {(-2,0) (-2,0.30)};
    \addplot[mseViaBlue!80!black, thick] coordinates {(-1,0) (-1,0.42)};
    \addplot[mseViaBlue!80!black, thick, dashed] coordinates {(0,0) (0,0.46)};
    \addplot[mseViaBlue!80!black, thick] coordinates {(1,0) (1,0.42)};
    \addplot[mseViaBlue!80!black, thick] coordinates {(2,0) (2,0.30)};
    \addplot[mseViaBlue!80!black, thick] coordinates {(3,0) (3,0.02)};
    ...
    \node[font=\scriptsize] at (axis cs:1.5,0.20) {13.6\%};
    \node[font=\scriptsize] at (axis cs:-0.5,0.28) {34.1\%};
    \node[font=\scriptsize] at (axis cs:0.5,0.28) {34.1\%};
    % Braces for 68.3%, 95.4%, 99.7%
    \draw[mseViaBlue!80!black, thick, decorate, decoration={brace, amplitude=4pt}] (axis cs:-1,-0.01) -- (axis cs:1,-0.01) node[midway, below=6pt, font=\scriptsize]{68.3\%};
    \draw[mseViaBlue!80!black, thick, decorate, decoration={brace, amplitude=4pt}] (axis cs:-2,-0.08) -- (axis cs:2,-0.08) node[midway, below=6pt, font=\scriptsize]{95.4\%};
    \draw[mseViaBlue!80!black, thick, decorate, decoration={brace, amplitude=4pt}] (axis cs:-3,-0.15) -- (axis cs:3,-0.15) node[midway, below=6pt, font=\scriptsize]{99.7\%};
    \end{axis}
    \end{tikzpicture}
    \caption{Empirical Rule on a normal curve using `mseViaBlue`. The inner bands mark $\pm1\sigma$ (68.3\%), $\pm2\sigma$ (95.4\%), and $\pm3\sigma$ (99.7\%).}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.32\textwidth}
        ...
        \par\small Left Skew
    \end{minipage}
    \caption{Relationship between mean, median, and mode for positively skewed, symmetric, and negatively skewed distributions. Curves and annotations use the book's color `mseViaBlue`.}
