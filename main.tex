...
\usetikzlibrary{intersections} % Required for name path and intersections
...
\input{msecolors} % Load custom colors matching the MkDocs website
...
%  % Assuming this is Probability
% \input{chapter04} % Assuming this is more Probability
% \input{chapter05} % Assuming this is Conditional Probability
% \input{chapter06} % Assuming this is Descriptive Statistics
...
% \input{chapter07} % Assuming this is Linear Equations
% \input{chapter08} % Assuming this is Vectors and Matrices
% \input{chapter09} % Assuming this is Matrix Algebra
...
\input{chapter10} % Differential Calculus
\input{chapter11} % Multivariable Calculus & Gradients (when you write it)
